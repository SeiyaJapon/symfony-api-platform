...
class DeleteMovementTest extends MovementTestBase
{
    ...
    {
        self::$manolo->request('DELETE', sprintf('%s/%s', $this->endpoint, $this->getPeterMovementId()));
    ...
    {
        self::$manolo->request('DELETE', sprintf('%s/%s', $this->endpoint, $this->getPeterGroupMovementId()));
