...
class DeleteCategoryTest extends CategoryTestBase
{
    ...
    {
        self::$manolo->request('DELETE', sprintf('%s/%s', $this->endpoint, $this->getPeterExpenseCategoryId()));
    ...
    {
        self::$manolo->request('DELETE', sprintf('%s/%s', $this->endpoint, $this->getPeterGroupExpenseCategoryId()));
